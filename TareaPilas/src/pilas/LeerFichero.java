...
public class LeerFichero {
	...
	public void lee() {
		try {
			...
			if (pila1.is_empty()) {
				...
				System.out.println("La expresión matemática SÍ está balanceada");
			} else {
	...
	public void lee2() {
		try {
			FileReader entrada = new FileReader("prueba2.txt");
			int c = 0;
			while (c != -1) {
				c = entrada.read();
				if (c != -1) {
	...
	public void lee3() {
		try {
			FileReader entrada = new FileReader("prueba3.txt");
			int c = 0;
			while (c != -1) {
				c = entrada.read();
				if (c != -1) {
